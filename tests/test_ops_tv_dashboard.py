...
class TestOpsTvDashboard(unittest.TestCase):
    ...
    def test_final_displays_include_count_segments_with_case_context(self):
        ...
        self.assertIn('id: "out_of_packaging"', metrics)
        self.assertIn("outOfPackagingBags", metrics)
        self.assertIn('r === "partial_packaging"', metrics)
        self.assertNotIn('r === "out_of_packaging"', metrics)
    ...
    def test_machine_settings_route_exists(self):
        ...
        self.assertEqual(r.status_code, 200)
        self.assertIn(b"Machine Settings", r.data)
