...
def sanitize_html(input_html: str | None, strip_tags: bool = False) -> str:
    """
    ...
    return bleach.clean(
        input_html, tags=ALLOWED_TAGS, attributes=ALLOWED_ATTRIBUTES, protocols=ALLOWED_PROTOCOLS, strip=True
    )
...
def sanitize_for_js(text: str | None) -> str:
    """
...
def sanitize_url(url: str | None, allowed_schemes: list | None = None) -> str | None:
    """
...
def sanitize_json_string(data: str | dict | list | None) -> str:
    """
