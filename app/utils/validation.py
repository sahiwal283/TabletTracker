...
def validate_positive_integer(value: Any, field_name: str = "value") -> str | None:
    """
...
def validate_date_format(date_str: str, field_name: str = "date") -> str | None:
    """
...
def validate_integer_range(
    value: Any, min_val: int | None = None, max_val: int | None = None, field_name: str = "value"
) -> str | None:
    """
...
def validate_file_extension(filename: str, allowed_extensions: list[str]) -> str | None:
    """
...
def validate_tracking_number(tracking_number: str, carrier: str | None = None) -> str | None:
    """
...
def validate_po_number(po_number: str) -> str | None:
    """
