...
def calculate_packaged_submission_total(
    submission: dict[str, Any], packages_per_display: int | None = None, tablets_per_package: int | None = None
) -> int:
    """
...
def calculate_repack_output_good(
    ...
    packages_per_display: int | None = None,
    tablets_per_package: int | None = None,
) -> int:
    """
...
def calculate_machine_submission_total(submission: dict[str, Any], tablets_per_package: int | None = None) -> int:
    """
...
def calculate_submission_total(
    ...
    packages_per_display: int | None = None,
    tablets_per_package: int | None = None,
    fallback_tablets_per_package: int | None = None,
) -> int:
    """
    ...
    if submission_type == 'machine':
        ...
        return calculate_repack_output_good(submission, packages_per_display, tablets_per_package)
    elif submission_type == 'bag':
        return calculate_bag_submission_total(submission)
    else:  # 'packaged' or default
        return calculate_packaged_submission_total(submission, packages_per_display, tablets_per_package)


def calculate_submission_total_with_fallback(
    submission: dict[str, Any],
    product_details: dict[str, Any] | None = None,
    fallback_product_details: dict[str, Any] | None = None,
) -> int:
    """
    ...
    return calculate_submission_total(
        submission, submission_type, packages_per_display, tablets_per_package, fallback_tablets_per_package
    )
