    ...
    mes_nav_boot = {
        "nav": [
            ...
            {"label": "Machines", "tab": "machines", "icon": "⚙"},
            {
                ...
                "href": url_for("receiving.receiving_list"),
                "external": True,
                "icon": "▣",
            },
            {"label": "Staging", "tab": "staging", "icon": "▤"},
            {"label": "Alerts", "tab": "alerts", "icon": "!"},
            {"label": "Reports", "href": url_for("reports.reports_view"), "external": True, "icon": "▦"},
            {"label": "Analytics", "href": url_for("reports.reports_view"), "external": True, "icon": "▧"},
            {"label": "Users", "href": url_for("admin.manage_employees"), "external": True, "icon": "◎"},
            {"label": "Settings", "href": url_for("admin.product_config"), "external": True, "icon": "☰"},
        ],
        "exit": {"label": "Exit to Command Center", "href": cc},
    }
